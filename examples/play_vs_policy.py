...
args = argparse.ArgumentParser(description="Play Tic Tac Toe against a trained policy.")
args.add_argument('npz_path', type=str, default='policy.npz', help='Path to the .npz file containing the policy.')
    ...
    while True:
        ...
        if current == human_player:
            ...
            if action not in env.get_available_actions():
                # fallback in case of missing or invalid action
